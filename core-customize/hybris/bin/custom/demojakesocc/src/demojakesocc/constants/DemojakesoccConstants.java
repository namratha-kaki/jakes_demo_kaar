 ...
 */
package demojakesocc.constants;

/**
 * Global class for all Demojakesocc constants. You can add global constants for your extension into this class.
 */
public final class DemojakesoccConstants extends GeneratedDemojakesoccConstants
{
	public static final String EXTENSIONNAME = "demojakesocc";
	...
	public static final String HOST = "demojakesocc.host";
	public static final String HOST_DEFAULT = "hostname";

	private DemojakesoccConstants()
	{
