 ...
 */
package jakeocc.constants;

/**
 * Global class for all Jakeocc constants. You can add global constants for your extension into this class.
 */
public final class JakeoccConstants extends GeneratedJakeoccConstants
{
	public static final String EXTENSIONNAME = "jakeocc";
	...
	public static final String HOST = "jakeocc.host";
	public static final String HOST_DEFAULT = "hostname";

	private JakeoccConstants()
	{
