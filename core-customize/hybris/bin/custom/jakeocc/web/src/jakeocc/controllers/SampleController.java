...
import jakeocc.data.UserDataList;
import jakeocc.dto.SampleWsDTO;
import jakeocc.dto.TestMapWsDTO;
import jakeocc.dto.UserWsDTO;
import jakeocc.dto.UsersListWsDTO;
import jakeocc.dto.UsersPageWsDTO;
import jakeocc.facades.SampleFacades;

import static jakeocc.constants.JakeoccConstants.CLIENT_CREDENTIAL_AUTHORIZATION_NAME;
import static jakeocc.constants.JakeoccConstants.PASSWORD_AUTHORIZATION_NAME;
import static jakeocc.constants.JakeoccConstants.SAMPLE_LIST_DOUBLE_VALUE;
import static jakeocc.constants.JakeoccConstants.SAMPLE_LIST_STRING_VALUE;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/jakeocc/sample/dto/sampleValue
	 *
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/jakeocc/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/jakeocc/sample/users
	 * <li>http://localhost:9001/jakeocc/sample/users?fields=users(info)
	 * <li>http://localhost:9001/jakeocc/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/jakeocc/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/jakeocc/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/jakeocc/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/jakeocc/sample/usersPaged
	 * <li>http://localhost:9001/jakeocc/sample/usersPaged?currentPage=1
	 * <li>http://localhost:9001/jakeocc/sample/usersPaged?currentPage=0?pageSize=1
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/jakeocc/sample/users/user1
	 * <li>http://localhost:9001/jakeocc/sample/users/user1?fields=info
	 * <li>http://localhost:9001/jakeocc/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/jakeocc/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/jakeocc/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/jakeocc/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 * <p>
	 * Url: http://localhost:9001/jakeocc/sample/map
	 */
